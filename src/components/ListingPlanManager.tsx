  ...
  return (
    <div className="space-y-6">
      ...
      <RazorpayPaymentModal
        ...
        studentEmail={institution.officialEmail || institution.contactPerson?.email || 'admin@institution.edu'}
        studentPhone={institution.mobileNumber || institution.contactPerson?.phone || '9876543210'}
